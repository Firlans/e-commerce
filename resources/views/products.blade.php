        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="w-full lg:w-64 space-y-6">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm">
                    ...
                    <div class="space-y-2">
                        @foreach(['Fiction', 'Non-Fiction', 'Children', 'Education', 'Religious'] as $category)
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" class="rounded border-amber-300 text-amber-600 focus:ring-amber-500">
                            <span class="text-amber-700">{{ $category }}</span>
                        </label>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="flex-1">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm mb-6">
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <select class="rounded-lg border-2 border-amber-200 focus:border-amber-400 focus:outline-none px-3 py-2">
                        ...
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div class="relative aspect-[3/4] overflow-hidden bg-amber-50">
                                ...
                                <div class="absolute top-3 right-3 space-y-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button class="p-2 rounded-full bg-white shadow-md text-amber-700 hover:text-amber-900">
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex items-center justify-between pt-2">
                                    ...
                                    <!-- Add to Cart -->
                                    <button class="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-100 text-amber-700 hover:bg-amber-700 hover:text-white transition-colors duration-300">
                ...
                <div class="mt-12 flex justify-center">
                    <nav class="flex items-center gap-2">
                        <button class="p-2 rounded-lg border-2 border-amber-200 text-amber-700 hover:bg-amber-100 disabled:opacity-50 disabled:cursor-not-allowed">
                            <i class="fa-solid fa-chevron-left"></i>
                        </button>
                        
                        <button class="px-4 py-2 rounded-lg bg-amber-700 text-white">1</button>
                        <button class="px-4 py-2 rounded-lg border-2 border-amber-200 text-amber-700 hover:bg-amber-100">2</button>
                        <button class="px-4 py-2 rounded-lg border-2 border-amber-200 text-amber-700 hover:bg-amber-100">3</button>
                        
                        <span class="px-4 py-2 text-amber-700">...</span>
                        
                        <button class="px-4 py-2 rounded-lg border-2 border-amber-200 text-amber-700 hover:bg-amber-100">12</button>
